...
router.post('/', (req, response) => {
  ...
  dat.from = 'Nexmo';
  dat.to = '919995727516';
  dat.text = 'A text message sent using the Nexmo SMS API';
  actionAPI.TextMessenger(dat, (error, message) => {
    if (!error) {
      console.log('222222222222222222');
      return response.status(200).json({ message: 'Msg send successfully' });
    }
  });
});
...
//           dat.to = '919995727516';
//           dat.text = 'A text message sent using the Nexmo SMS API';
//           sendMessage(dat,(error,response)=>{
//              if (error) {
//              }
//              else{
...
// const sendMessage = (dat, callback) => {
// var nexmo = new Nexmo(
//   {
//     apiKey: '067908e3',
